...
If you want to explore all that `nix-effects` has to offer—beware of scary words, but an awesome open world of future-Nix possibilities—take a look at the [docs website](https://docs.kleisli.io/nix-effects).
</Aside>
...
Den will be using `denful/nix-effects`, based on `denful/nfx`, based on `denful/fx-rs` based on `denful/fx.go`.
