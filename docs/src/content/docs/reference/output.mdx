...
[`per system tests`](https://github.com/denful/den/blob/main/templates/ci/modules/public-api/packages-merge.nix)
</Aside>
...
2. Allow aspects to produce `packages`.
     ...
     # The system-to-os-outputs policy handles per-host fan-out.
...
See [`packages-merge.nix`](https://github.com/denful/den/blob/main/templates/ci/modules/public-api/packages-merge.nix) for worked examples.
